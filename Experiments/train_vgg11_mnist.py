...
def train_vgg11_mnist(min_epochs=20, max_epochs=100, batch_size=32, model_seed=42, data_seed=42, learning_rate=0.1, data_augmentation=False):
    ...
    datamodule_hparams = {'batch_size': batch_size, 'data_dir': BASE_DATA_DIR, 'resize': (32, 32), 'seed': data_seed, 'data_augmentation': data_augmentation}
    ...
    model, datamodule, trainer = setup_training(f'VGG-11 MNIST B{batch_size}', model_type, model_hparams, lightning_params, datamodule_type, datamodule_hparams, min_epochs=min_epochs, max_epochs=max_epochs, wandb_tags=wandb_tags)
