...
def train_vgg11_cifar100(min_epochs=50, max_epochs=200, batch_size=32, model_seed=42, data_seed=42, learning_rate=0.1, data_augmentation=True):
    ...
    model, datamodule, trainer = setup_training(f'VGG-11 CIFAR-100 B{batch_size}', model_type, model_hparams, lightning_params, datamodule_type, datamodule_hparams, min_epochs=min_epochs, max_epochs=max_epochs, wandb_tags=wandb_tags)
