...
def run_experiment():
    ...
    model, datamodule, trainer = setup_training(f'VGG-11 CIFAR-100 B32', model_type, model_hparams, datamodule_type, datamodule_hparams, max_epochs=max_epochs, wandb_tags=wandb_tags)
