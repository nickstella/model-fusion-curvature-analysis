...
def train_vgg11_cifar100(max_epochs=1, batch_size=32):
    ...
    model, datamodule, trainer = setup_training(f'VGG-11 CIFAR-100 B{batch_size}', model_type, model_hparams, datamodule_type, datamodule_hparams, max_epochs=max_epochs, wandb_tags=wandb_tags)
