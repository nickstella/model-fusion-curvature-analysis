...
def train_resnet18_cifar100(min_epochs=50, max_epochs=200, batch_size=32, model_seed=42, data_seed=42, learning_rate=0.1, data_augmentation=True):
    ...
    lightning_params = {'optimizer': 'sgd', 'lr': learning_rate, 'momentum': 0.9, 'weight_decay': 0.0001, 'lr_scheduler': 'plateau', 'lr_decay_factor': 0.1, 'lr_monitor_metric': 'val_loss', 'model_seed': model_seed}
